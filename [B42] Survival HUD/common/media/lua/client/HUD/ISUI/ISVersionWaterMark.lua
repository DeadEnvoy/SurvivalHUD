...
WaterMarkUI.render = function(self)
	...
	self:setWidth(200); self:setX(getCore():getScreenWidth() - 10 - self.width);

	local hudHeight = SurvivalHUD.BaseIconSize + 26;
	self:setY(getCore():getScreenHeight() - hudHeight);
